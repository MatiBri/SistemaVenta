...
//Esta clase con el comando colocado, fueron creadas a partir de todas las tablas que estan en la base de datos con SQL. A estas tablas se les llama entidades, al ser una representación de las tablas
//A través de este comando, se pudo hacer todo esto automáticamente:
//Scaffold-DbContext "Data Source=(local)\SQLEXPRESS;Initial Catalog=TUDB;Integrated Security=True;Encrypt=False" Microsoft.EntityFrameworkCore.SqlServer
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-R244QF5; DataBase=DBVENTA;Integrated Security=true;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C3AEDD322");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F4AE117A1");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483EAA8053C");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E10789CE3AEC");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EDFB01F5F");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1320FCB1962");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F7611A9CA23");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D883755D96");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE29BB403C");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6946E3FA2");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56144C9AB14C");
